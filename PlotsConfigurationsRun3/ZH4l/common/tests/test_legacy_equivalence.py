...
def test_validated_payloads_and_physics_kernels_are_byte_identical():
    pairs = (
        ...
        (
            LEGACY / "ZZ_CR/macros/four_lepton_helpers.cc",
            FAMILY / "common/macros/objects.cc",
        ),
        (
            LEGACY / "ZZ_CR/macros/selected_trigger_wrappers.cc",
            FAMILY / "common/macros/trigger.cc",
        ),
        (LEGACY / "ZZ_CR/macros/fixed_wp_btag_sf.cc", FAMILY / "common/macros/btag.cc"),
        (
            LEGACY / "PairingStudy/macros/pairing_study.cc",
            FAMILY / "Pairing/macros/pairing.cc",
        ),
    )
...
def test_accepted_public_rename_is_semantic_not_algorithmic():
    ...
    mapping = {
        '        "z_lepton_index": {': "bestZ0IdxWithID",
        '        "x_lepton_index": {': "xPairIdxWithID",
        'aliases["z_mass"]': "pairMass",
        'aliases["x_mass"]': "pairMass",
        'aliases["zx_mass"]': "fourLeptonMassFromPairs",
        'aliases["zx_pt"]': "fourLeptonPtFromPairs",
        'aliases["zx_min_pair_mass"]': "minimumSelectedPairMass",
        'aliases["zx_charge"]': "sumLeptonChargeFromPairs",
    }
