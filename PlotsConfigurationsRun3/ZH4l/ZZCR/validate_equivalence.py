...
HISTOGRAM_AXES = {
    ...
    "z_pt": ((0, 2, 4, 6, 8, 10, 15, 20, 25, 30, 35, 40, 50, 60, 70, 80, 100, 120), 3),
    "x_pt": ((0, 2, 4, 6, 8, 10, 15, 20, 25, 30, 35, 40, 50, 60, 70, 80, 100, 120), 3),
    "zx_pt": ((0, 20, 40, 60, 80, 100, 150, 200, 300, 400), 2),
    "PuppiMET_pt": ((0, 10, 20, 30, 40, 50, 80, 100, 120), 3),
    "zx_min_pair_mass": ((0, 4, 8, 12, 16, 20, 30, 40, 60, 80), 3),
    "veto_lepton_count": ((-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5), 3),
}
...
variables = {
    "equivalence": {
        "tree": {
            ...
            "eq_z_mass": "double(Z0_mass)",
            "eq_x_mass": "double(X_mass)",
            "eq_zx_mass": "double(m4l)",
            "eq_z_pt": "double(Z0_pt)",
            "eq_x_pt": "double(X_pt)",
            "eq_zx_pt": "double(pT4l)",
            "eq_PuppiMET_pt": "double(PuppiMET_pt)",
            "eq_zx_pass_ordered_pt": "bool(Passes4lOrderedPt)",
            "eq_event_pass_extra_lepton_veto": "bool(fifthLeptonVeto)",
            "eq_zx_min_pair_mass": "double(minSelectedPairMass)",
            "eq_event_pass_b_veto": "bool(physicalBtagVeto)",
            "eq_veto_lepton_count": "int(Sum(Lepton_pt >= 10.f))",
...
variables = {
    "equivalence": {
        "tree": {
            ...
            "luminosityBlock": "luminosityBlock",
            "event": "event",
            "eq_Z_idx0": "int(Alt(z_lepton_index,0,-1))",
            "eq_Z_idx1": "int(Alt(z_lepton_index,1,-1))",
            "eq_X_idx0": "int(Alt(x_lepton_index,0,-1))",
            "eq_X_idx1": "int(Alt(x_lepton_index,1,-1))",
            "eq_z_mass": "double(z_mass)",
            "eq_x_mass": "double(x_mass)",
            "eq_zx_mass": "double(zx_mass)",
            "eq_z_pt": "double(z_pt)",
            "eq_x_pt": "double(x_pt)",
            "eq_zx_pt": "double(zx_pt)",
            "eq_PuppiMET_pt": "double(PuppiMET_pt)",
            "eq_zx_pass_ordered_pt": "bool(zx_pass_ordered_pt)",
            "eq_event_pass_extra_lepton_veto": "bool(event_pass_extra_lepton_veto)",
            "eq_zx_min_pair_mass": "double(zx_min_pair_mass)",
            "eq_event_pass_b_veto": "bool(event_pass_b_veto)",
            "eq_veto_lepton_count": "int(veto_lepton_count)",
            "eq_inZZCR": "bool(" + zzcr + ")",
            "eq_inZZCR_4e": "bool((" + zzcr + ") && z_is_ee && x_is_ee)",
            "eq_inZZCR_4mu": "bool((" + zzcr + ") && z_is_mumu && x_is_mumu)",
            "eq_inZZCR_2e2mu": "bool((" + zzcr + ") && ((z_is_ee && x_is_mumu) || (z_is_mumu && x_is_ee)))",
