...
public:
  ...
  fake_rate_reader( TString ele_WP, TString muon_WP, TString kind, uint nLeptons, TString electron_tight_charge, const std::vector<std::string>& input_files, TString year );
...
fake_rate_reader::fake_rate_reader( TString ele_WP,
  ...
  TString fake_muon_file_name_20 = input_files.at(0).c_str();
  TString fake_muon_file_name_30 = input_files.at(1).c_str();
  TString fake_muon_file_name_40 = input_files.at(2).c_str();

  TString fake_ele_file_name_20  = input_files.at(3).c_str();
  TString fake_ele_file_name_30  = input_files.at(4).c_str();
  TString fake_ele_file_name_40  = input_files.at(5).c_str();

  // Prompt rate input files
  TString pr_muon_file_name = input_files.at(6).c_str();
  TString pr_ele_file_name  = input_files.at(7).c_str();
