...
fake_input_paths = fake_payloads(fakerates, "2024_v15_pt", "cutBased_LooseID_tthMVA_Run3", muWP)
...
aliases['fakeW'] = {
    ...
    'linesToProcess' : [f"ROOT.gInterpreter.ProcessLine('fake_rate_reader fr_reader = fake_rate_reader(\"cutBased_LooseID_tthMVA_Run3\", \"{muWP}\", \"nominal\", 2, \"std\", {fake_inputs}, \"2024_v15_pt\");')"],
