...
histo_WW = ptll_dir.Get("histo_WW")
histo_WZ = ptll_dir.Get("histo_WZ")
histo_WZS = ptll_dir.Get("histo_WZS")
histo_ZZ = ptll_dir.Get("histo_ZZ")
histo_Zg = ptll_dir.Get("histo_Zg")
...
histo_trueData.Add(histo_WW, -1)
histo_trueData.Add(histo_WZ, -1)
histo_trueData.Add(histo_WZS, -1)
histo_trueData.Add(histo_ZZ, -1)
histo_trueData.Add(histo_Zg, -1)
