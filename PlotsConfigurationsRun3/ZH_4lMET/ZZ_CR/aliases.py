...
def _l2tight_leading2_expr(era):
    ...
    Each of the two leading leptons must pass at least one tight electron or muon WP.
    """
...
aliases["dPhi_MET_lZ1"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(PuppiMET_phi, Alt(Lepton_phi, Alt(Z0_idx, 0, -1), -999.f))"
}
aliases["dPhi_MET_lZ2"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(PuppiMET_phi, Alt(Lepton_phi, Alt(Z0_idx, 1, -1), -999.f))"
}
aliases["dPhi_MET_lX1"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(PuppiMET_phi, Alt(Lepton_phi, Alt(X_idx, 0, -1), -999.f))"
}
aliases["dPhi_MET_lX2"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(PuppiMET_phi, Alt(Lepton_phi, Alt(X_idx, 1, -1), -999.f))"
}
aliases["dPhi_MET_ZplusX"] = {"expr": "ZH4lMETZZCR::deltaPhi(PuppiMET_phi, phi4l)"}

aliases["dPhi_lZ1_lZ2"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(Alt(Lepton_phi, Alt(Z0_idx, 0, -1), -999.f), Alt(Lepton_phi, Alt(Z0_idx, 1, -1), -999.f))"
}
aliases["dPhi_lZ1_lX1"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(Alt(Lepton_phi, Alt(Z0_idx, 0, -1), -999.f), Alt(Lepton_phi, Alt(X_idx, 0, -1), -999.f))"
}
aliases["dPhi_lZ1_lX2"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(Alt(Lepton_phi, Alt(Z0_idx, 0, -1), -999.f), Alt(Lepton_phi, Alt(X_idx, 1, -1), -999.f))"
}
aliases["dPhi_lZ2_lX1"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(Alt(Lepton_phi, Alt(Z0_idx, 1, -1), -999.f), Alt(Lepton_phi, Alt(X_idx, 0, -1), -999.f))"
}
aliases["dPhi_lZ2_lX2"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(Alt(Lepton_phi, Alt(Z0_idx, 1, -1), -999.f), Alt(Lepton_phi, Alt(X_idx, 1, -1), -999.f))"
}
aliases["dPhi_lX1_lX2"] = {
    "expr": "ZH4lMETZZCR::deltaPhi(Alt(Lepton_phi, Alt(X_idx, 0, -1), -999.f), Alt(Lepton_phi, Alt(X_idx, 1, -1), -999.f))"
}
