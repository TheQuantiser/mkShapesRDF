...
aliases["m4l"] = {
    "expr": "ZH4lMETZZCR::fourLeptonMass(Lepton_pt, Lepton_eta, Lepton_phi, Lepton_pdgId)",
}

aliases["pT4l"] = {
    "expr": "ZH4lMETZZCR::fourLeptonPt(Lepton_pt, Lepton_eta, Lepton_phi, Lepton_pdgId)",
}
