...
> **LEGACY / HISTORICAL EVIDENCE.** This audit concerns the former four-lepton
> ZZCR/SR analysis and is not the active DY-only RunStability selection.
> Expressions, helpers, tests, and “current” statements below are historical
> within that former configuration. Use [README.md](../README.md),
> [CONFIGURATION.md](../CONFIGURATION.md), and
> [TRIGGER_SCALE_FACTORS.md](../TRIGGER_SCALE_FACTORS.md) for supported
> RunStability behavior.
