...
> **LEGACY / HISTORICAL EVIDENCE.** This source record documents the former
> four-lepton ZH/ZZCR/SR implementation, not the active DY-only RunStability
> selection. References below to `macros/four_lepton_helpers.cc`, former
> selected-pair tests, region registries, and “executable/current” behavior are
> preserved historical statements; those files or interfaces may have been
> removed or replaced. Do not use this file as a runbook. Use
> [README.md](../README.md), [ARCHITECTURE.md](../ARCHITECTURE.md),
> [CONFIGURATION.md](../CONFIGURATION.md), and
> [TRIGGER_SCALE_FACTORS.md](../TRIGGER_SCALE_FACTORS.md) for the active
> contract.
