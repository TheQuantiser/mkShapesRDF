...
> **LEGACY / HISTORICAL EVIDENCE.** This pre-edit plan describes a retired
> multi-region configuration. Its proposed runner, stage-in behavior, profiles,
> category counts, filenames, and tests are not active RunStability guidance.
> Preserve it as dated evidence; use [README.md](../README.md),
> [ARCHITECTURE.md](../ARCHITECTURE.md), and
> [USAGE.MD](../USAGE.MD) for the supported DY-only workflow.
...
3. Extend `run_stability_runner.py` locally so it books and saves only approved
