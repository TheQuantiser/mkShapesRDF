...
> **LEGACY / HISTORICAL EVIDENCE.** “Final” refers only to the dated 2026-08-09
> compact-production campaign described here. This is not the final or current
> DY-only RunStability contract. Former multi-region selections, category
> counts, helpers, tests, wrappers, and production identities may no longer
> exist. Use [README.md](../README.md),
