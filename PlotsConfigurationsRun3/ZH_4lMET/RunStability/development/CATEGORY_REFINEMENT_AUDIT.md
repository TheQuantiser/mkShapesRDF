...
> **LEGACY / HISTORICAL EVIDENCE.** This dated audit records a former
> multi-region configuration and its then-current addenda. Counts, profiles,
> passes, paths, wrappers, and tests below are not the active DY-only
> RunStability interface. Preserve them as audit evidence; use
> [README.md](../README.md), [ARCHITECTURE.md](../ARCHITECTURE.md), and
> [CONFIGURATION.md](../CONFIGURATION.md) for current behavior.
...
10. **Files outside scope?** No tracked source outside
    `PlotsConfigurationsRun3/ZH_4lMET/RunStability` was changed.
