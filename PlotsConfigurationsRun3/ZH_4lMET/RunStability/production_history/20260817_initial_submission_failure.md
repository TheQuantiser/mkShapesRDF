...
> **Historical failed-production receipt.** This file preserves the original
> scheduler and transport failure. It is not current RunStability source,
> configuration, luminosity, or submission guidance. Use
> [README.md](README.md) for the status index and the leaf's active `USAGE.MD`
