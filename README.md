...
`start.sh` is generated by that installation and is intentionally absent from a
fresh checkout. Do not source it before the first successful `./install.sh`.
